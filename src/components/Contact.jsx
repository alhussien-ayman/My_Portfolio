...
const socialLinks = [
  {
    href: "https://github.com/alhussien-ayman/Alhussien_Ayman",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "www.linkedin.com/in/alhussien-ayman-488336249",
    icon: (
      <svg
        width="24"
        height="24"
...
{
  href: "https://www.facebook.com/alhussien.ayman",
  icon: (
    <svg
      width="24"
      height="24"
    ...
    >
      <path
        d="M12 2C6.47715 2 2 6.47715 2 12C2 16.9912 5.65685 21.1289 10.4375 21.8789V14.8906H7.89844V12H10.4375V9.79688C10.4375 7.28906 11.9306 5.90625 14.215 5.90625C15.3081 5.90625 16.4531 6.10156 16.4531 6.10156V8.5625H15.1672C13.8984 8.5625 13.5625 9.37109 13.5625 10.2031V12H16.3359L15.8906 14.8906H13.5625V21.8789C18.3431 21.1289 22 16.9912 22 12C22 6.47715 17.5228 2 12 2Z"
        stroke="currentColor"
        strokeWidth="1.5"
        fill="none"
      />
...
,
  ...
  {
    href: "https://www.instagram.com/alhussien_ayman/",
    icon: (
      <svg
        width="25"
        height="24"
    ...
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          <h2 className="text-left headline-2 lg:max-w-[22ch] reveal-up">
            Contact me for collaboration
          </h2>
          <p className="text-zinc-400 mt-3 mb-8 max-w-[70ch] lg:max-w-[50ch] text-left reveal-up">
          ...
          <div className="flex items-center gap-2 mt-auto">
            {socialLinks.map(({ href, icon }, key) => (
              <a
                ...
                href={href}
                target="_blank"
                className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/8 reveal-up"
              >
                {icon}
              </a>
            ))}
        ...
        <form action="https://getform.io/f/axoyplqb" method="POST" className="xl:pl-10 2xl:pl-20">
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                autoComplete="email"
                required
                placeholder="alhussien@example.com"
                className="text-field reveal-up"
              />
            </div>
          </div>
